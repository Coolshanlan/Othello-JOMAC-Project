...
namespace 黑白棋
{
    public partial class UCT_Othello_Learning : Form
    {
        int white = 2;
        int black = 2;
        ...
        //}
        //--------------------------------------------------------------------------------------------------
        public UCT_Othello_Learning(bool ll)
        {
            Learn = ll;
        ...
        string contxt = @"Data Source=JOEY-PC;Initial Catalog=Othello;Integrated Security=True;Pooling=False";
